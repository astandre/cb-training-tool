...
db.session.add(Triple(subject='ObtenerInformacion-Sentence-2', predicate='hasText', object="Muestrame un resumen del mooc?"))
db.session.add(Triple(subject='ObtenerInformacion-Sentence-3', predicate='hasText', object="Contenido del curso "))
db.session.add(Triple(subject='ObtenerInformacion-Sentence-4', predicate='hasText', object="Breve introducción al curso"))
...
db.session.add(Triple(subject='ObtenerFechas-Sentence-1', predicate='hasText', object="Cuales son las fechas importantes del curso?"))
db.session.add(Triple(subject='ObtenerFechas-Sentence-2', predicate='hasText', object="Fechas clave del curso"))
db.session.add(Triple(subject='ObtenerFechas-Sentence-3', predicate='hasText', object="Que fechas debo tomar en cuenta"))
...
db.session.add(Triple(subject='ObtenerFechasInicio-Sentence-1', predicate='hasText', object="Cuándo empiezan los cursos ?"))
db.session.add(Triple(subject='ObtenerFechasInicio-Sentence-2', predicate='hasText', object="Fecha de inicio de los moocs?"))
db.session.add(Triple(subject='ObtenerFechasInicio-Sentence-3', predicate='hasText', object="Día de inicio de los moocs ?"))
db.session.add(Triple(subject='ObtenerFechasInicio-Sentence-4', predicate='hasText', object="En que fechá inician los moocs?"))
...
db.session.add(Triple(subject='ObtenerPrerequisitos', predicate='hasSentence', object="ObtenerPrerequisitos-Sentence-1"))
db.session.add(Triple(subject='ObtenerPrerequisitos', predicate='hasSentence', object="ObtenerPrerequisitos-Sentence-2"))
db.session.add(Triple(subject='ObtenerPrerequisitos', predicate='hasSentence', object="ObtenerPrerequisitos-Sentence-3"))
db.session.add(Triple(subject='ObtenerPrerequisitos', predicate='hasSentence',object="ObtenerPrerequisitos-Sentence-4"))
db.session.add(Triple(subject='ObtenerPrerequisitos', predicate='hasSentence',object="ObtenerPrerequisitos-Sentence-5"))
db.session.add(Triple(subject='ObtenerPrerequisitos-Sentence-1', predicate='hasText', object="Cuáles son los prerequisitos?"))
db.session.add(Triple(subject='ObtenerPrerequisitos-Sentence-2', predicate='hasText', object="Requisitos previos de ingreso "))
db.session.add(Triple(subject='ObtenerPrerequisitos-Sentence-3', predicate='hasText', object="Dame a conocer los prerequisitos"))
db.session.add(Triple(subject='ObtenerPrerequisitos-Sentence-4', predicate='hasText',object="Me puedes indicar los prerequistos necesarios?"))
db.session.add(Triple(subject='ObtenerPrerequisitos-Sentence-5', predicate='hasText',object="Que necesito saber antes de iniciar el curso"))

# Intencion obtener duracion

db.session.add(Triple(subject='ObtenerDuracion', predicate='rdf:type', object="Intent"))
db.session.add(Triple(subject='ObtenerDuracion', predicate='hasDescription',object="¿Como preguntarias por la duracion de un curso?"))
...
db.session.add(Triple(subject='ObtenerDuracion-Sentence-4', predicate='hasText', object="En cuántas semanas se realiza el curso? "))
...
db.session.add(Triple(subject='ObtenerPrecio', predicate='hasDescription', object="¿Como preguntarias por el precio de un curso?"))
...
db.session.add(Triple(subject='ObtenerDocente-Sentence-1', predicate='hasText', object="Quién es mi profesor en el curso?"))
...
db.session.add(Triple(subject='ObtenerDocente-Sentence-4', predicate='hasText', object="Quién es el docente encargado de la materia?"))
db.session.add(Triple(subject='ObtenerDocente-Sentence-5', predicate='hasText', object="Nombre del docente del mooc"))
db.session.add(Triple(subject='ObtenerDocente-Sentence-6', predicate='hasText', object="Que profesor esta a cargo del curso"))
...
db.session.add(Triple(subject='ObtenerContenidos-Sentence-2', predicate='hasText', object="Cuál es la temática de cada curso?"))
db.session.add(Triple(subject='ObtenerContenidos-Sentence-3', predicate='hasText', object="Qué temas se van a tratar en cada curso?"))
